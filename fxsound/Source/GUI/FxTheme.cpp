...
{ { 0x181818, 0x181818, 0x383838, 0x2b2b2b, 0xb1b1b1, 0x000000, 0xffffff, 0x0c0c0c, 0xffffff,
	...
	0xd51535, 0xfe566a, 0xef4b65, 0x742834, 0xf3f3f3, 0x414141, 0x000000, 0xb1b1b1, 0xe63462 },

  { 0xf5f5f5, 0xf5f5f5, 0xc7c7c7, 0xfafafa, 0x4e4e4e, 0xffffff, 0x000000, 0xe0e0e0, 0x000000,
	0xd7d7d7, 0x1ac1ff, 0x23b6eb, 0x7f7f7f, 0x009cdd, 0xd51535, 0xe0e0e0, 0x0a4d66, 0x53ccff,
	0x1ac1ff, 0x72d8ff, 0x33c8ff, 0x063244, 0x1c1c1c, 0xb9b9b9, 0xc0c0c0, 0x4e4e4e, 0x23b6eb} };
...
{
	return Font(font_600_).withHeight(kNormalFontHeight);
}
...
Font FxTheme::getNormalFontForLanguage(String language)
{
    ...
    return Font(typeface).withHeight(kNormalFontHeight);
}

Font FxTheme::getTextButtonFont(TextButton&, int button_height)
{
	return Font(font_600_.get()).withHeight(jmin(kNormalFontHeight, (float)button_height));
}
...
{
	return Font(font_400_).withHeight(kSmallFontHeight);
}

Font FxTheme::getTitleFont()
{
	return Font(font_700_).withHeight(kNormalFontHeight);
}
