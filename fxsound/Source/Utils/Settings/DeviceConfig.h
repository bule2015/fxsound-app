...
namespace FxSound
{
    struct DeviceConfig
    {
        ...
        juce::String container_id;
        juce::String preset;

        static void initDeviceConfigs(Settings& settings, const std::vector<SoundDevice>& sound_devices);
        ...
        static DeviceConfig getDeviceConfig(Settings& settings, const SoundDevice& sound_device);
