...
private:
	...
	std::atomic<uint64_t> capture_signal_latch_deadline_ms_ = 0;
...
namespace FxSound
{
	...
	{
		inline bool shouldContinueCleanupAfterThreadShutdown(bool thread_shutdown_succeeded, bool timed_out)
		{
			return thread_shutdown_succeeded && !timed_out;
		}
	}
}
